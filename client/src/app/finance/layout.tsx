...
import { LayoutDashboard, Boxes, Users, DollarSign, TrendingUp, CreditCard, FileText, PieChart } from 'lucide-react'
...
const nav = [
  ...
  { name: 'Finance', href: '/finance', icon: <DollarSign />, active: true },
]
